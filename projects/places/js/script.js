	  ...
	  // }
			...
			if (places.length == 1) {
				...
				for (var i = 0, result; result = places[i]; i++) {
					...
					if(result.opening_hours && result.opening_hours.open_now) {
						$(".place_list#open_places").append('<div class="card multiple_locations"><div class="green_border"></div><div class="card_info"><div class="hidden place_address">' + result.formatted_address + '</div><div class="place_name">' + result.name + '</div><div class="place_rating more_card_info hidden">Ratings: ' + (result.rating?result.rating:" - ") + '</div><div class="place_price_level more_card_info hidden">Price: ' + (result.price_level?price_index:" - ") + '</div><div class="place_open more_card_info hidden"><span class="green_text">open</span></div><div class="blue_link show_on_map more_card_info hidden right">Navigate here</div><div class="similar_locations blue_link more_card_info hidden">Find similar locations</div><div class="location hidden">' + result.geometry.location + '</div><div class="location_type hidden">' + result.types[0] + '</div></div></div>');
					} else if(result.opening_hours && !result.opening_hours.open_now) {
						$(".place_list#closed_places").append('<div class="card multiple_locations"><div class="red_border"></div><div class="card_info"><div class="hidden place_address">' + result.formatted_address + '</div><div class="place_name">' + result.name + '</div><div class="place_rating more_card_info hidden">Ratings: ' + (result.rating?result.rating:" - ") + '</div><div class="place_price_level more_card_info hidden">Price: ' + (result.price_level?price_index:" - ") + '</div><div class="place_open more_card_info hidden"><span class="red_text">closed</span></div><div class="blue_link show_on_map more_card_info hidden right">Navigate here</div><div class="similar_locations blue_link more_card_info hidden">Find similar locations</div><div class="location hidden">' + result.geometry.location + '</div><div class="location_type hidden">' + result.types[0] + '</div></div></div>');
					} else {
						$(".place_list#closed_places").append('<div class="card multiple_locations"><div class="gray_border"></div><div class="card_info"><div class="hidden place_address">' + result.formatted_address + '</div><div class="place_name">' + result.name + '</div><div class="place_rating more_card_info hidden">Ratings: ' + (result.rating?result.rating:" - ") + '</div><div class="place_price_level more_card_info hidden">Price: ' + (result.price_level?price_index:" - ") + '</div><div class="place_open more_card_info hidden"><span class="gray_text">undefined time</span></div><div class="blue_link show_on_map more_card_info hidden right">Navigate here</div><div class="similar_locations blue_link more_card_info hidden">Find similar locations</div><div class="location hidden">' + result.geometry.location + '</div><div class="location_type hidden">' + result.types[0] + '</div></div></div>');
					}
		...
		function createMarker(place) {
			...
			service.getDetails(place, function(result, status) {
				...
				if(result.opening_hours && result.opening_hours.open_now) {
					$(".place_list#open_places").append('<div class="card"><div class="green_border"></div><div class="card_info"><div class="place_name">' + result.name + '</div><div class="blue_link place_phone more_card_info hidden">' + (result.formatted_phone_number?result.formatted_phone_number:" - ") + '</div><div class="place_address hidden">' + result.formatted_address + '</div><div class="place_distance more_card_info hidden"></div><div class="place_open more_card_info hidden"><span class="green_text">open</span></div><div class="blue_link show_on_map more_card_info hidden right">Navigate here</div><div class="similar_locations blue_link more_card_info hidden">Find similar locations</div><div class="location hidden">' + result.geometry.location + '</div><div class="location_type hidden">' + result.types[0] + '</div></div></div>');
				} else if(result.opening_hours && !result.opening_hours.open_now) {
					$(".place_list#closed_places").append('<div class="card"><div class="red_border"></div><div class="card_info"><div class="place_name">' + result.name + '</div><div class="blue_link place_phone more_card_info hidden">' + (result.formatted_phone_number?result.formatted_phone_number:" - ") + '</div><div class="place_address hidden">' + result.formatted_address + '</div><div class="place_distance more_card_info hidden"></div><div class="place_open more_card_info hidden"><span class="red_text">closed</span></div><div class="blue_link show_on_map more_card_info hidden right">Navigate here</div><div class="similar_locations blue_link more_card_info hidden">Find similar locations</div><div class="location hidden">' + result.geometry.location + '</div><div class="location_type hidden">' + result.types[0] + '</div></div></div>');
				} else {
					$(".place_list#closed_places").append('<div class="card"><div class="gray_border"></div><div class="card_info"><div class="place_name">' + result.name + '</div><div class="blue_link place_phone more_card_info hidden">' + (result.formatted_phone_number?result.formatted_phone_number:" - ") + '</div><div class="place_address hidden">' + result.formatted_address + '</div><div class="place_distance more_card_info hidden"></div><div class="place_open more_card_info hidden"><span class="gray_text">undefined time</span></div><div class="blue_link show_on_map more_card_info hidden right">Navigate here</div><div class="similar_locations blue_link more_card_info hidden">Find similar locations</div><div class="location hidden">' + result.geometry.location + '</div><div class="location_type hidden">' + result.types[0] + '</div></div></div>');
				}
			});
