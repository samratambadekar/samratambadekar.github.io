...
$(document).ready(function() {
  ...
  //   });
  // });
  $("#configureC2A").load("configureC2A.html", function() {
    $(this).trigger("pagecreate");
    $.getScript("js/script_configureC2A.js", function() {
    });
  });
  $("#shareC2A").load("shareC2A.html", function() {
    $(this).trigger("pagecreate");
    $.getScript("js/script_shareC2A.js", function() {
    });
  });
  ...
  $("body").on("click", ".navigate_to_manage", function(evt) {
    // evt.stopImmediatePropogation();
  ...
  $("body").on("click", ".btn-prev", function(evt) {
    ...
    $(".btn-next").removeClass("navigate_home navigate_to_manage");
    window.location.href = window.location.href.split("#")[0] + "#" + $(".ndse_page.selected").attr("data-step-num");
    flowProgressIndicator();
  });
...
function checkButtonVisibility(currentIndex) {
  window.setTimeout(function() {
    if($(".ndse_page.selected").hasClass("taggerDocument") || $(".ndse_page.selected").hasClass("configureC2A")) {
      setTimeout(function() {
        $("#bottomNav").removeClass("hide_bottom_nav");
      }, 300);
    } else {
    ...
    // }
    if($(".ndse_page.selected").attr("data-step-name") == "Send") {
      $(".btn-next").text("Send");
      $(".btn-next").addClass("navigate_home");
    } else {
      $(".btn-next").text("Next");
    ...
    if($(".ndse_page.selected").attr("data-step-name") == "Share") {
      $(".btn-next").text("Save & Close");
      $(".btn-next").addClass("navigate_to_manage");
    } else {
      $(".btn-next").text("Next");
      $(".btn-next").removeClass("navigate_to_manage");
    }
  }, 300);
