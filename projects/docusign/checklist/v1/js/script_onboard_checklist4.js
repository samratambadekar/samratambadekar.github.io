$(document).ready(function() {
  ...
  $("body").on("click", ".checklist_card", function(evt) {
    ...
    if($(this).attr("data-card-name") == "upload_pic" && !$(this).hasClass("completed")) {
      ...
      $(this).addClass("animate_transition_layer");
...
function updateCount() {
  ...
  $(".manage4 .chklst_itms_left").text(completedCount);
  $(".manage4 .progress_indicator .progress_indicator_bar").css("width", (100*completedCount/5) + "%");
}
