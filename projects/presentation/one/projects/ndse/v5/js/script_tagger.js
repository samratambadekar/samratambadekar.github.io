...
$(".content_sidebar-left").on("mousedown", "button.item.btn,button.menu_item", function(evt) {
  ...
  if($(this).attr("data-qa") == "Signature") {
    newTag = $('<div class="newTagDraggable draggable SignatureTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><img style="cursor: auto;" src="images/svg/SignHereActive150.svg"/></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Initial") {
    newTag = $('<div class="newTagDraggable draggable InitialsTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><img src="images/svg/InitialHereActive150.svg" style="pointer-events: none;" width="34" height="40"/></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Date Signed") {
    newTag = $('<div class="newTagDraggable draggable DateSignedTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><span>Date Signed</span></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Name") {
    newTag = $('<div class="newTagDraggable draggable NameTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><span>Full Name</span></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Email") {
    newTag = $('<div class="newTagDraggable draggable EmailTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><span>Email</span></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Company") {
    newTag = $('<div class="newTagDraggable draggable CompanyTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><span>Company</span></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Title") {
    newTag = $('<div class="newTagDraggable draggable TitleTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><span>Title</span></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Text") {
    newTag = $('<div class="newTagDraggable draggable DataTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><span>Text</span></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Checkbox") {
    newTag = $('<div class="newTagDraggable draggable CheckboxTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><input type="checkbox" class="input-cb"/></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Dropdown") {
    newTag = $('<div class="newTagDraggable draggable DropdownTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><span>Select</span><img src="images/svg/uE062-triangle.svg" style="pointer-events: none;"/></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Radio") {
    newTag = $('<div class="newTagDraggable draggable RadioTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><input type="radio" class="input-rb"/></div><div class="the_tag" style="background-color: ' + svgFillColor + '"><input type="radio" class="input-rb"/></div><div class="the_tag" style="background-color: ' + svgFillColor + '"><input type="radio" class="input-rb"/></div><div class="the_tag" style="background-color: ' + svgFillColor + '"><input type="radio" class="input-rb"/></div><div class="the_tag" style="background-color: ' + svgFillColor + '"><input type="radio" class="input-rb"/></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Attachment") {
    newTag = $('<div class="newTagDraggable draggable AttachmentTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><img src="images/svg/tag-attachment.svg"/></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Note") {
    newTag = $('<div class="newTagDraggable draggable NoteTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><img src="images/svg/field-note.svg" style="pointer-events: none;" width="12" height="12" x="2" y="2"/></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Approve") {
    newTag = $('<div class="newTagDraggable draggable ApproveTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><span>Approve</span></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Decline") {
    newTag = $('<div class="newTagDraggable draggable DeclineTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><span>Decline</span></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Formula") {
    newTag = $('<div class="newTagDraggable draggable FormulaTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><img src="images/svg/tag-formula.svg" style="pointer-events: none;" width="9" height="8.031048387096773" x="3" y="1"/></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
    // $("#documentTags").append(newTag);
    $(".tagger_content").append(newTag);
    moveNewTag(evt);

  } else if($(this).attr("data-qa") == "Payment") {
    newTag = $('<div class="newTagDraggable draggable PaymentTabView" data-name="' + $(this).attr("data-qa") + '" data-tag-for="' + tagForRecipient + '"><div style="display: flex"><div class="the_tag" style="background-color: ' + svgFillColor + '"><span>$0.00</span></div><img class="tag_settings" style="cursor:pointer;" src="images/svg/gear_icon.svg"/></div><div class="tag_settings_options hidden"><div class="strong">Recipient</div><button type="button" data-qa="recipient-selector" class="btn btn-select btn-block btn-trigger btn-recipients u-ellipsis ng-scope"><span class="swatch-recipient swatch-sm swatch swatch-round swatch-ext-0"></span><span class="ng-binding">Alex Edwards</span></button><div class="menu select-menu toolbarRecipientsMenu invisible"><ul role="menu"><li data-qa="recipient-1" class="ng-scope" role="menuitem"><button class="item on"><span class="swatch swatch-round swatch-recipient swatch-ext-0" data-qa="recipient-list-name-1"></span><span class="ng-binding">Alex Edwards</span></button></li><li data-qa="recipient-2" class="ng-scope" role="menuitem"><button class="item"><span class="swatch swatch-round swatch-recipient swatch-ext-1" data-qa="recipient-list-name-2"></span><span class="ng-binding">Corey Kimel</span></button></li></ul><ul role="menu" aria-labelledby=""><li role="menuitem"><div class="item" data-qa="edit-recipients-swatch">Edit Recipients</div></li></ul></div><div class="tag_actions"><div class="link">Show Advanced Settings</div><div class="icon icon-trash deleteTag"></div></div></div></div>');
...
$("body").on("click", ".btn-recipients", function(evt) {
  ...
  $(this).next(".toolbarRecipientsMenu").css({top: $(this).position().top + $(this).outerHeight(), left: $(this).position().left});
});
