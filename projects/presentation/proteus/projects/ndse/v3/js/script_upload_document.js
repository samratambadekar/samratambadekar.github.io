...
function uploadNewFile(newFile) {
  $("#sortableDocuments .file").each(function(idx, elem) {
      $(elem).css({"z-index": $("#sortableDocuments .file").length - idx});
  });
