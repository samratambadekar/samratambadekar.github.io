...
$(document).ready(function() {
  ...
  $("#sortableSections").on("focus", "[contentEditable=true], [type='text']", function(evt) {
    ...
    $(".showAsSideBarRight #sortableSections").animate({scrollTop: $("#sortableSections").scrollTop() + $(this).closest(".card").offset().top - 200});
  });
  ...
  $(".blocks").on("mousedown", ".menu_listItem", function(evt) {
    ...
    if($(this).attr("title") == "Paragraph") {
      // console.log("new");
      var newItem = $('<div class="card item" style=""><span class="handle"><i class="icon icon-handle"></i></span><div class="field-name empty" contenteditable="true" placeholder="Add Text">Add Text</div><div class="card-options"><div class="search callout-target"><img src="images/svg/search-doc.svg"></div></div></div>');
  ...
  $("body").on("click", ".start-editing-labels", function(evt) {
    ...
    var targetEl = $(".card[data-link-id='field-101'] .handle");
    ...
    setTimeout(function() {
      ...
      targetEl.attr("callout-pos", "above left");
  ...
  $("body").on("click", ".callout-target[data-callout='blocks_info']", function(evt) {
    ...
    $(this).attr("callout-pos", "before top");
    showCallout(evt, $(this));
  });

  $("body").on("click", ".callout-target.search", function(evt) {
    $(".tooltip.callout > div").addClass("hidden");
    $(".tooltip.callout > .callout-field-image").removeClass("hidden");

    $(this).attr("callout-pos", "above right");
    showCallout(evt, $(this));
  });
...
function allTheDancingAround() {
  $("#sidebarRight").addClass("newMinWidth hideRight");
  // setTimeout(function() {
    // $("#sidebarLeft").addClass("hideLeft");
    // $("#sidebarRight").addClass("hideRight");
  // }, 2000);
  setTimeout(function() {
    // $("#taggerDocument").addClass("hideLeft");
    // $("#sidebarRight").addClass("newMinWidth");
    // $("#createForm").removeClass("hideRight");
  ...
  setTimeout(function() {
    // $("#siteTopToolbar .toolbar_tagger").addClass("hideTop");
    // $("#siteTopToolbar .toolbar_smart_form").removeClass("hideTop");
  //   $("#sidebarRight").removeClass("newMinWidth");
  //   $("#taggerDocument").addClass("hideLeft");
    $(".scanner_line").removeClass("animate");
    $(".doc_scanner").addClass("hide");
    $("#sortableSections").addClass("overflow");
    $(".spinner").addClass("hide");
    $(".toolbar_smart_form").removeClass("hideTop");
  }, 4000);
  // setTimeout(function() {
  //   $("#taggerDocument").addClass("hide");
  //   $("#createForm").addClass("translateCenter");
  // }, 6300);
  setTimeout(function() {
  ...
  //   $("#createForm").removeClass("showAsSideBarRight translateCenter");
  //   // addBlocksScript();
  //   $(".sidebarTabs_tab[data-qa='Blocks']").click();
  //   $("#sidebarLeft").removeClass("hideLeft");
}, 4500);
// console.log("ready");
}
