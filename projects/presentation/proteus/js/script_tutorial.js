...
$(document).ready(function() {
  ...
  $("body").on("click", ".diagram_prototyping", function(evt) {
    // evt.stopPropagation();
    // if($(".diagram_prototyping.stage1").hasClass("hidden")) {
    //   $(".diagram_prototyping.stage1").removeClass("hidden");
    //   $(".diagram_prototyping.stage2").addClass("hidden");
    // } else {
    //   $(".diagram_prototyping.stage1").addClass("hidden");
    //   $(".diagram_prototyping.stage2").removeClass("hidden");
    // }
    $(".diagram_prototyping").removeClass("hidden");
  });
