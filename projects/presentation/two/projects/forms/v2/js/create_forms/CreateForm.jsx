    ...
    return (
      <div id="" className="">
        <div id="" className="new_form new_form-1">
          <div className="slider relative left hidden">
            <div draggable="true"><img src="images/slider_arrow.svg"/></div>
          </div>

          <div className="blocks expanded">
                  ...
                  <div className="sender_profile text-center">
                    ...
                    <div className="profile_intro disabled_element">
                      ...
                      <div className="disclosure_info">
                        By selecting START you are agreeing to the
                        <div className="link" data-feature-code="Disclosure Link">Electronic Records and Signature Disclosure.</div>
                        <div className="btn btn-primary btn-next">Start</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="title_card" data-ignore-sortable="true">
                ...
                <div id="" className="cards sortableItems">
                  ...
                  <div className="card item uneditable-card" data-link-id="field-112">
                    <span className="hatch"></span>
                    <span className="handle"><i className="icon icon-handle"></i></span>
                    <div className="field-name optional" contentEditable="true" placeholder="Label (optional)" data-preview-id="emailAddress">Email (optional)</div>
                    <div className="field-input"><input className="input-text disabled" placeholder=""/></div>
                  </div>
              ...
              <div className="title_card" data-ignore-sortable="true">
                ...
                <div id="" className="cards sortableItems">
                  <div className="card item" data-link-id="field-219">
                    ...
                    <div className="field-input text-center attachment">
