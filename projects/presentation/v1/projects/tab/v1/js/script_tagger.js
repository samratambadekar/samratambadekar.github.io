...
$("body").on("keydown", function(evt) {
  ...
  if((evt.keyCode == 13 || evt.keyCode == 32) && $(".DropdownTabView").hasClass("selected")) {
    evt.preventDefault();
  ...
  if(((evt.keyCode >= 48 && evt.keyCode <= 57) || (evt.keyCode >= 65 && evt.keyCode <= 90)) && $(".DropdownTabView").hasClass("selected") && !selectedTag.find(".dropdown_menu .select-menu").hasClass("invisible")) {
    evt.preventDefault();
...
function dropdownKeySearch(keyCode) {
  if(!joinNextKey) {
...
$(".content_main").on("focus", ".newTagDraggable .the_tag input, .newTagDraggable .the_tag textarea", function(evt) {
  // evt.stopPropagation();
  deleteTagAllowed = false;
});
$(".content_main").on("blur", ".newTagDraggable .the_tag input, .newTagDraggable .the_tag textarea", function(evt) {
